...
parser.add_argument('--gpus', nargs=1, type=str, default='0', help='list of gpus to use, e.g. 0,1,2 (default: %(default)s)', metavar='GPUS')
...
parser.add_argument('--batch_size', type=int, default=50, help='input batch size (default: %(default)s)', metavar='B')
