...
parser.add_argument('--epochs', type=int, default=1000, help='number of training epochs (default: %(default)s)')
parser.add_argument('--warm_epochs', type=int, default=50, help='number of warming epochs (default: %(default)s)')
parser.add_argument('--step_size', type=int, default=50, help='number of warming epochs (default: %(default)s)')
parser.add_argument('--push_interval', type=int, default=100, help='epoch interval in which to push prototypes (default: %(default)s)')
