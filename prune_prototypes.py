...
parser.add_argument('--n_iter', type=int, default=15, help='number of iterations to run for last layer optimization after pruning. If 0, do not optimize last layer. (default: %(default)s)')
